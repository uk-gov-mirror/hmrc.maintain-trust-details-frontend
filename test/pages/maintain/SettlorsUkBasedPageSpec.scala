...
class SettlorsUkBasedPageSpec extends PageBehaviours {

  "SettlorsUkBasedPage" must {

    beRetrievable[Boolean](SettlorsUkBasedPage)

    beSettable[Boolean](SettlorsUkBasedPage)

    beRemovable[Boolean](SettlorsUkBasedPage)

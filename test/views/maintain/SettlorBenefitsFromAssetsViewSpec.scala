...
class SettlorBenefitsFromAssetsViewSpec extends YesNoViewBehaviours {
  ...
  "SettlorBenefitsFromAssetsView" must {

    val view = viewFor[SettlorBenefitsFromAssetsView](Some(emptyUserAnswers))
    ...
    behave like yesNoPage(form, applyView, messageKeyPrefix, None, routes.SettlorBenefitsFromAssetsController.onSubmit().url)

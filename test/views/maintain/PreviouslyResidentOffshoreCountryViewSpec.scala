...
class PreviouslyResidentOffshoreCountryViewSpec extends SelectCountryViewBehaviours {

  val messageKeyPrefix = "previouslyResidentOffshoreCountry"

  val form: Form[String] = new CountryFormProvider().withPrefix(messageKeyPrefix)

  "PreviouslyResidentOffshoreCountryView" must {

    val view = viewFor[PreviouslyResidentOffshoreCountryView](Some(emptyUserAnswers))

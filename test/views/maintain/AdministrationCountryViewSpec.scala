...
class AdministrationCountryViewSpec extends SelectCountryViewBehaviours {

  val messageKeyPrefix = "administrationCountry"

  val form: Form[String] = new CountryFormProvider().withPrefix(messageKeyPrefix)

  "AdministrationCountryView" must {

    val view = viewFor[AdministrationCountryView](Some(emptyUserAnswers))

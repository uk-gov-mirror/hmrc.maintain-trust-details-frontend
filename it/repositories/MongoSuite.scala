...
trait MongoSuite extends ScalaFutures {
  ...
  private val connectionString = "mongodb://localhost:27017/maintain-trust-details-frontend-it"

  private def getDatabase(connection: MongoConnection): Future[DefaultDB] = {
    connection.database("maintain-trust-details-frontend-integration")
  }
